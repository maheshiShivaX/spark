...
const ProductSubCategory = () => {
    ...
    const GetProductSubCategory = async () => {
        try {
            const response = await get(endpoints.GetProductSubCategory)
            console.log('datar', response);
            if (response.isSuccess === 200) {
    ...
    const onSave = async (e) => {
        e.preventDefault();
        try {
            const response = await post(endpoints.SaveProductSubCategory, formData);
            if (response.isSuccess === 200) {

                toast.success("Product Sub Category save successfully");
                onReset();
                GetProductSubCategory();
    ...
    const onDelete = async (id) => {
        ...
        const response = await get(endpoints.DeleteProductSubCategoryById + "?pProductSubCategoryId=" + id)
        if (response.isSuccess == 200) {
            GetProductSubCategory();
        }
    }
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <div className="action_btn_weepr">
                                                        ...
                                                        <span className="delete_icon_weepr" onClick={() => onDelete(item.productSubCategoryId)}>
                    ...
                    <div className="modal-content">
                        ...
                        <div class="modal-body">
                            <form onSubmit={onSave}>
                                ...
                                <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <div className="send_quote_wepper">
                                        <input type="text" name="productSubCategoryName" id="productSubCategoryName" className="form-control" placeholder="Category Name" required value={formData.productSubCategoryName} onChange={handleChange} />
                                    </div>
                                </div>
                                <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <div className="send_quote_wepper">
                                ...
                                <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <div className="send_quote_wepper">
                                        <input type="text" name="productSubCategoryCode" id="productSubCategoryCode" className="form-control" placeholder="Category Code" required value={formData.productSubCategoryCode} onChange={handleChange} />
                                    </div>
                                </div>
                                <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <div className="send_quote_wepper">
