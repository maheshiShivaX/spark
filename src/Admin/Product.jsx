...
const Product = () => {
    ...
    const GetProductDetail = async () => {
        try {
            const response = await get(endpoints.GetProductDetail)
    ...
    const GetProductSubCategoryByCategoryId = async (id) => {



        try {
            const response = await get(endpoints.GetProductSubCategoryByCategoryId + "?pProductCategoryId=" + id)
            console.log('datar', response);
            if (response.isSuccess === 200) {
    ...
    const onDelete = async (id) => {
        ...
        const response = await get(endpoints.DeleteProductDetailById + "?pProductDetailId=" + id)
        if (response.isSuccess == 200) {
            GetProductDetail();
        }
    }
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await post(endpoints.SaveProductDetail, formData);
            if (response.isSuccess === 200) {
    ...
    const handleCategoryChange = (e) => {
        ...
        GetProductSubCategoryByCategoryId(categoryId);
    };
                                    ...
                                    {productDetailData?.length > 0 ? (
                                        productDetailData?.map((item, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>{item.inculdeItem}</td>
                                                <td>{item.warrenty}</td>
                                                <td>{item.salePrice}</td>
                                                <td>{item.createdDate}</td>
                                                <td><Link to={`/admin/productdetail/${item.productId}`}>view</Link></td>
                                                ...
                                                <td>
                                                    <div className="action_btn_weepr">
                                                        ...
                                                        <span className="delete_icon_weepr" onClick={() => onDelete(item.productId)}>
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <select name="productCategoryId" id="productCategoryId" className="form-control" value={formData.productCategoryId} onChange={handleCategoryChange} required >
                                    ...
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <select name="productSubCategoryId" id="productSubCategoryId" className="form-control" value={formData.productSubCategoryId} onChange={handleChange} required >
                                                <option value="0" className="option">Select Sub Category</option>
                                                {subCategoryData?.map((item, i) => (
                                                    <option key={item.productSubCategoryId} value={item.productSubCategoryId} className="option">{item?.productSubCategoryName}</option>
                                                ))}
                                            </select>
                                    ...
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <input type="text" name="productName" id="productName" className="form-control" placeholder="Product Name" required value={formData.productName} onChange={handleChange} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <input type="text" name="productCode" id="productCode" className="form-control" placeholder="Product Code" required value={formData.productCode} onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <input type="text" name="modelName" id="modelName" className="form-control" placeholder="Model Name" required value={formData.modelName} onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                    ...
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <input type="text" name="shortDesc" id="shortDesc" className="form-control" placeholder="Short Desc" value={formData.shortDesc} onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <input type="text" name="inculdeItem" id="inculdeItem" className="form-control" placeholder="Include Items" value={formData.inculdeItem} onChange={handleChange} />
                                        </div>
                                    </div>

                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <input type="text" name="warrenty" id="warrenty" className="form-control" placeholder="Warrenty" value={formData.warrenty} onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <div className="send_quote_wepper">
                                            <input type="text" name="salePrice" id="salePrice" className="form-control" placeholder="Sale Price" value={formData.salePrice} onChange={handleChange} />
                                        </div>
                                    </div>
                                </div>
