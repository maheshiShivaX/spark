...
const Banner = () => {
    ...
    return (
        ...
        <div>
                                        ...
                                        <div className="row form_data">
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <label htmlFor="message">First sdfsdfdsfdsName*</label>
            ...
            <section>
                <div className="banner_weppper">
                    <img src="images/banner.png" alt="" className="w-100" />
                    <div className="banner_content">
                        <h1>Experience the Difference.</h1>
                        <p>We are Denver's Most Affordable and Most Reliable HVAC Company offering Factory Direct, Wholesale
                            Pricing to the Public.</p>
                        <Link className="book_appointment_click" onClick={() => setShowAppointmentSidebar(true)} >Let’s Connect <img src="images/right-arrow.svg" alt="" /></Link>
                    </div>
                </div>
            </section>
        </div>
