    ...
    return (
        <div>
            ...
            <section className="pb-4">
                <div className="book_services_bg">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <div className="book_content">
                                    <h2>Schedule Your Service <br /> Appointment Now.</h2>
                                    <p>"We're revolutionizing the HVAC industry by offering homeowners reliable and trustworthy
                                        services."</p>
