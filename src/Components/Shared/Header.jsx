                ...
                <nav className="navbar navbar-light  navbar-expand-lg">
                    <div className="container">
                        ...
                        <div className='login_mobile_wepper'>
                            <Link to="/login"> <img src="images/add-to-cart.svg" alt="" className="mobile_show cart_icon" /></Link>
                        ...
                        <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar"
                            ...
                            <div className="offcanvas-body">
                                ...
                                <div className="add_to_cart_wepper">
                                    <Link to="/add-quotation">   <img src="images/add-to-cart-dark.svg" alt="" className="mobile_show" />
                                     <img src="images/add-to-cart.svg" alt="" className="destop_show" />{`${totalQuantity}`} </Link>
